...
# JSON-FG Feature with DGGS location data (Schema)

`pangaea.terranexus.dggs.api.feature-dggs` *v0.1*

either GeoJSON or FG-JSON with DGGS zone
...
```jsonld
{
  "@context": [
    ...
    "https://geofizzydrink.github.io/test_bblock/build/annotated/terranexus/dggs/api/feature-dggs/context.jsonld",
...
<http://examples.terranexus.com/dggs-api/2305843009229499373> a geojson:Feature ;
    ...
    dcterms:provenance terranexusCollections:osm_singapore_buildings,
        ...
        <https://terranexus.pangaeainnovations.comprov/agents/%3COrganisation%3E>,
        agents:MapDataToZones,
...
<https://terranexus.pangaeainnovations.comprov/agents/%3COrganisation%3E> a <http://examples.terranexus.com/dggs-api/organization>,
        prov:Agent .
...
description: JSON-FG Feature Collection with Provenance Chain for DGGS actions
allOf:
- anyOf:
  - $ref: https://geofizzydrink.github.io/test_bblock/build/annotated/terranexus/dggs/api/geojson-feature_with-prov/schema.yaml
  - $ref: https://geofizzydrink.github.io/test_bblock/build/annotated/terranexus/dggs/api/json-fg-feature_with-prov/schema.yaml
- properties:
    properties:
      required:
      - dggsZones
...
* YAML version: [schema.yaml](https://geofizzydrink.github.io/test_bblock/build/annotated/terranexus/dggs/api/feature-dggs/schema.json)
* JSON version: [schema.json](https://geofizzydrink.github.io/test_bblock/build/annotated/terranexus/dggs/api/feature-dggs/schema.yaml)
...
[context.jsonld](https://geofizzydrink.github.io/test_bblock/build/annotated/terranexus/dggs/api/feature-dggs/context.jsonld)
